...
const ClubCard = (props: ClubCardProps) => {
  ...
  return (
    <div className="h-full  flex flex-col  min-h-[400px] min-w-[300px] max-w-xs md:min-h-[600px]  rounded-lg bg-white shadow-lg  transition hover:scale-105">
      ...
      <div className="m-5 mt-auto flex flex-row gap-4">
        <Link
          href={club.url}
          className="px-4 py-2 bg-cornflower-500 rounded-full text-xs font-extrabold text-white transition-colors hover:bg-royal"
        >
          Join
        </Link>
        <Link
